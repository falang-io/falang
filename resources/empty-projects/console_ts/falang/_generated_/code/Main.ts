...
// Falang:icon-end:function_header:7a08ec6c-a176-4eac-90b7-599ff6976ec0
{
  ...
  // Falang:icon-start:foreach:9ce83c63-f746-4f0a-93b3-9244beac6b04
  // Falang:block-start:icon-box-9ce83c63-f746-4f0a-93b3-9244beac6b04
  for(let i = 1; i <= 10; i++)
  // Falang:block-end:icon-box-9ce83c63-f746-4f0a-93b3-9244beac6b04
  {
    // Falang:icon-start:skewer:5c842542-5eee-464c-ba4b-891edc0f5e7a
    ...
    // Falang:icon-end:skewer:5c842542-5eee-464c-ba4b-891edc0f5e7a
  }
  // Falang:icon-end:foreach:9ce83c63-f746-4f0a-93b3-9244beac6b04
