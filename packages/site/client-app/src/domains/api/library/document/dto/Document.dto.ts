/* File was copied from /server/src/domains/library/document/dto/Document.dto.ts */
//import type { ISchemeJson, TProjectType, TSchemeIcon } from '@falang/project';
import { ISchemeDto, IconDto } from '@falang/editor-scheme';
...
export class DocumentDto implements ISchemeDto {
  schemeVersion: 2 = 2;
  type = '';
  @IsString()
  @IsNotEmpty()
