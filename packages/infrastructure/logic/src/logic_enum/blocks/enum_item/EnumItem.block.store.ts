...
export interface IEnumItemBlockStoreParams extends IBlockStoreParams, EnumItemBlockDto {}

const KEYS_WIDTH = CELL_SIZE * 3;

export class EnumItemBlockStore extends LogicBaseBlockStore {
  readonly keyStore: Text2Store;
  readonly valueStore: Text2Store;

  constructor(params: IEnumItemBlockStoreParams) {
    super(params);
