...
export interface IArrShiftBlockStoreParams extends IBlockStoreParams, ArrShiftBlockDto {}

const BADGES_WIDTH = CELL_SIZE_4;

export class ArrShiftBlockStore extends LogicBaseBlockStore {
  arrExpr: Expression2Store;
  variableExpr: Expression2Store;

  constructor(params: IArrShiftBlockStoreParams) {
    super(params);
