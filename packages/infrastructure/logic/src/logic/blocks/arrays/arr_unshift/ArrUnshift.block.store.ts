...
export interface IArrUnshiftBlockStoreParams extends IBlockStoreParams, ArrUnshiftBlockDto {}

const BADGES_WIDTH = CELL_SIZE_4;

export class ArrUnshiftBlockStore extends LogicBaseBlockStore {
  arrExpr: Expression2Store;
  variableExpr: Expression2Store;

  constructor(params: IArrUnshiftBlockStoreParams) {
    super(params);
